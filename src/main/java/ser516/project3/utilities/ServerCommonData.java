...
public class ServerCommonData {
	...
	/**
	 * @param lowerFace - sets the lowerFace attribute
	 */
	...
	/**
	 * @param upperFace - sets the upperFace attribute
	 */
	...
	/**
	 * @param eye - sets the eye attribute
	 */
	...
	/**
	 * @param eyeAutoReset - sets the eye Auto Reset attribute
	 */
	...
	/**
	 * @param lowerFaceAct - sets the Lower Face Activated Button Status attribute
	 */
	...
	/**
	 * @param upperFaceAct - sets the Upper Face Activated Button Status attribute
	 */
	...
	/**
	 * @param eyeAct - sets the Eye Activated Button Status attribute
	 */
